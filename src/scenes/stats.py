...
STATS_CONFIG = [
    ...
    {"name": t("Health"),        "key": "health",        "icon": ICON_HEALTH,
     "desc": t("desc_health")},
    {"name": t("Fullness"),      "key": "fullness",      "icon": ICON_FULLNESS,
     "desc": t("desc_fullness")},
    {"name": t("Energy"),        "key": "energy",        "icon": ICON_ENERGY,
     "desc": t("desc_energy")},
    {"name": t("Comfort"),       "key": "comfort",       "icon": ICON_COMFORT,
     "desc": t("desc_comfort")},
    {"name": t("Cleanliness"),   "key": "cleanliness",   "icon": ICON_CLEANLINESS,
     "desc": t("desc_cleanliness")},
    {"name": t("Fitness"),       "key": "fitness",       "icon": ICON_FITNESS,
     "desc": t("desc_fitness")},

    # Row 1 — Mental & Emotional
    {"name": t("Focus"),         "key": "focus",         "icon": ICON_FOCUS,
     "desc": t("desc_focus")},
    {"name": t("Intelligence"),  "key": "intelligence",  "icon": ICON_INTELLIGENCE,
     "desc": t("desc_intelligence")},
    {"name": t("Curiosity"),     "key": "curiosity",     "icon": ICON_CURIOSITY,
     "desc": t("desc_curiosity")},
    {"name": t("Playfulness"),   "key": "playfulness",   "icon": ICON_PLAYFULNESS,
     "desc": t("desc_playfulness")},
    {"name": t("Affection"),     "key": "affection",     "icon": ICON_AFFECTION,
     "desc": t("desc_affection")},
    {"name": t("Fulfillment"),   "key": "fulfillment",   "icon": ICON_FULFILLMENT,
     "desc": t("desc_fulfillment")},

    # Row 2 — Emotional (cont.) & Character
    {"name": t("Serenity"),         "key": "serenity",         "icon": ICON_SERENITY,
     "desc": t("desc_serenity")},
    {"name": t("Sociability"),      "key": "sociability",      "icon": ICON_SOCIABILITY,
     "desc": t("desc_sociability")},
    {"name": t("Courage"),          "key": "courage",          "icon": ICON_COURAGE,
     "desc": t("desc_courage")},
    {"name": t("Loyalty"),          "key": "loyalty",          "icon": ICON_LOYALTY,
     "desc": t("desc_loyalty")},
    {"name": t("Mischievousness"),  "key": "mischievousness",  "icon": ICON_MISCHIEVOUS,
     "desc": t("desc_mischievousness")},
    {"name": t("Maturity"),         "key": "maturity",         "icon": ICON_MATURITY,
